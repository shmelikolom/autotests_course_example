...
# Здесь пишем код
def segment(point_one, point_two):  # Функция сложения координат
    try:
        return point_one[0] + point_one[1] + point_two[0] + point_two[1]  # Возвращаем сумму координат
    except Exception as e:
        # Если возникала ошибка при сложении, возвращает текст исключения задом наперед
