...
def treatment_sum(our_tuple: tuple):
    ...
    ----------
    our_tuple : tuple
        Кортеж элементов для сложения

    Возвращаемое значение
    ---------------------
    Если в кортеже 2 элемента и их можно сложить, то функция возвращает получившийся результат

    Если в кортеже 2 элемента и их нельзя сложить, то функция обрабатывает исключение и
    возвращает строку 'Нельзя сложить эти данные'

    Если в кортеже меньше двух элементов, то функция обрабатывает исключение и возвращает строку 'Недостаточно данных'

    Если в кортеже больше двух элементов, то функция генерирует исключение Exception 'Много данных'
    """
    if len(our_tuple) > 2:
